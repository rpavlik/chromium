...
static void crServerViewportClipToWindow (const CRrecti *imagewindow, CRrecti *q) 
{
...
static void crServerViewportConvertToOutput (const CRrecti *imagewindow,
							  const CRrecti *outputwindow, CRrecti *q) 
{
