...
SPUOptions fpsSPUOptions[] = {
   { "report_frames", CR_INT, 1, "10", "0", NULL, "How many frames between reports", (SPUOptionCB)report_frames},
   { "report_seconds", CR_FLOAT, 1, "1.0", "0", NULL, "How many seconds between reports", (SPUOptionCB)report_seconds},
