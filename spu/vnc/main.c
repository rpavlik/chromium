 ...
 *
 * $Id: main.c,v 1.10 2007-02-23 10:11:48 mduerig Exp $
 * Main module
 */
 ...
 */
#ifdef CHROMIUM
CR_THREAD_PROC_DECL vnc_main(void *arg)
#else
...
#if CHROMIUM
  g_screen_info.width = vnc_spu.screen_width;
  g_screen_info.height = vnc_spu.screen_height;
#endif
