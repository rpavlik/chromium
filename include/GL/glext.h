...
typedef void (APIENTRY * PFNGLGETPROGRAMSTRINGNVPROC) (GLuint id, GLenum pname, GLint *program);
...
/* Added to match useful stuff from previous glext.h that we were using */
