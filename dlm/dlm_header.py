...
/* DO NOT EDIT.  This file is auto-generated by dlm.py. */
#define CR_DLM_H
...
void DLM_APIENTRY crDLMSendAllLists(CRDLM *dlm, CRClientState *restoreClientState, 
	SPUDispatchTable *dispatchTable);
void DLM_APIENTRY crDLMSendList(CRDLM *dlm, unsigned long listIdentifier,
...
CRDLMError DLM_APIENTRY crDLMGetBounds(CRDLM *dlm, unsigned long listIdentifier, CRDLMBounds *bounds);
void DLM_APIENTRY crDLMSetBounds(CRDLM *dlm, unsigned long listIdentifier, double xmin, double ymin, double zmin, double xmax, double ymax, double zmax);
GLboolean DLM_APIENTRY crDLMListHasBounds(CRDLM *dlm, unsigned long listIdentifier);
...
/* auto-generated DLM compilation functions begin here */
"""
...
for func_name in keys:
	...
	print 'void DLM_APIENTRY crDLMCompile%s( %s );' % (func_name, argstring)
